...
function time() {
    ...
    var timerId=setInterval(function(){
        ...
        /*得到剩余时间中的  时  分  秒*/
        /*获取时*/
        var hour=Math.floor(totalTime/3600);//1
        /*获取分*/
        var minute=Math.floor(totalTime%3600/60);//1
        /*获取秒*/
        var second=Math.floor(totalTime%60);//40
        /*赋值，将时间填充到span中  12*/
        spans[0].innerHTML=Math.floor(hour/10);//0.1
        spans[1].innerHTML=Math.floor(hour%10);//1

        spans[3].innerHTML=Math.floor(minute/10);//0.1
        spans[4].innerHTML=Math.floor(minute%10);//1
